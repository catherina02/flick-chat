...
class ChatService extends ChangeNotifier {
  ...
  String attachmentUrlFor(ChatMessage message) {
    if (message.messageType == 'text') {
      return message.attachmentUrl ?? '';
    }
    final existing = message.attachmentUrl;
    if (existing != null && existing.contains('token=')) {
      return existing;
    }
    return _api.messageAttachmentUrl(message.id);
  }
